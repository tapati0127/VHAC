...
class BertEncoder(nn.Module):
    ...
    def forward(self, token_ids, segment_ids, attention_mask):
        output = self.bert_model(
            input_ids=token_ids, token_type_ids=segment_ids, attention_mask=attention_mask
        )
        ...
        if self.additional_linear is not None:
            ...
            # }, "/media/c4i/DATA10/annh148/vn-core/ViEntityLinking/test/eval/data.t7")

            # self.bert_model.save_pretrained("/media/c4i/DATA10/annh148/vn-core/ViEntityLinking/test/eval")
        else:
