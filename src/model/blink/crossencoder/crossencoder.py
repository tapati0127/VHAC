    ...
    def __init__(self, params, tokenizer):
        ...
        if params.get('bert_base_dir'):
            encoder_model = AutoModel.from_pretrained(
                params['bert_base_dir'], local_files_only=True)
        else:
            encoder_model = AutoModel.from_pretrained(params['bert_model'])
        ...
        # print("out_dim", params["out_dim"])
        # print("pull_from_layer", params["pull_from_layer"])
        # print("add_linear", params["add_linear"])
...
class CrossEncoderRanker(torch.nn.Module):
    def __init__(self, params, shared=None):
        ...
        if params["path_to_model"] is not None:
            self.load_model(params["path_to_model"], cpu=(self.device.type=='cpu'))
