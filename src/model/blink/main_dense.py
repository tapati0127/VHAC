...
def _load_candidates(
    ...
    with open(entity_catalogue, 'r') as fin:
        ...
        for line in lines:
            ...
            id2systemid[local_idx] = entity['_id']
            id2aliases[local_idx] = [entity['title']]\
                                    # + entity['aliases']
            id2location[local_idx] = entity.get('location')
            local_idx += 1
    return (
        candidate_encoding,
        title2id,
...
def _run_biencoder(biencoder, dataloader, candidate_encoding, top_k=100, indexer=None, device=None):
